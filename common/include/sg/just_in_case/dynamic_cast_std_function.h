...
template <class F, class = void_t<>> struct parameters {};

template <class F>
struct parameters<F, void_t<decltype(&F::operator())>> : parameters<decltype(&F::operator())> {};

template <class R, class... Params> struct parameters<R(Params...)> {
...
template <class T, class R, class... Params> struct parameters<R (T::*)(Params...)> {
    using type = pack<Params...>;
};

template <class T, class R, class... Params> struct parameters<R (T::*)(Params...) const> {
    using type = pack<Params...>;
};
} // namespace dynamic_cast_std_function_detail_parameters
...
template <class F>
using parameters = typename dynamic_cast_std_function_detail_parameters::parameters<
    std::remove_reference_t<F>>::type;

/** @brief dynamic cast for argumnets of std::function<> */
template <class F, class... Ps> auto dynamic_cast_std_function(F &&f, pack<Ps...>) {
...
/** @brief dynamic cast for argumnets of std::function<> */
template <class F> auto dynamic_cast_std_function(F &&f) {
